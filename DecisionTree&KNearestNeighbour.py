...
def main():
    ...
    print("Accuracy of classification algorith with Decision Tree classifier is",Accuracy*100,"%")

    Accuracy = MarvellousCalculateAccuracyKNeighbor()
    print("Accuracy of classification algorith with K Neighbor classifier is",Accuracy*100,"%")
